...
void vkutil::copyImageToImage(VkCommandBuffer ccommandBuffer, VkImage source, VkImage destination, VkExtent2D srcSize, VkExtent2D dstSize)
{
	...
	vkCmdBlitImage2(ccommandBuffer, &blitInfo);
}
